...
urlpatterns = [
    ...
    path('modern-outs-diary/', views.modern_outs_diary_page, name='modern_outs_diary_page'),
    path('api/modern-outs-diary/', views.ModernOutsAPIView.as_view(), name='modern-outs-diary-api'),
